...
Public Class frmPresentacionesListado
...
#Region " FUNCIONES INTERNAS "
    ...
    Private Sub CargarGrilla_Detalles()
        ...
        Dim nId_Presentacion As Integer = Request.QueryString("nropresentacion")
...
#End Region
    ...
    Protected Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        Response.Redirect("/frmPresentacionesListado.aspx?nropresentacion=" & nNroPresentacion.ToString &
    ...
    Protected Sub grd_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles grd.RowCommand
        ...
        If e.CommandName = "VerDetalles" Then
            ...
            Response.Redirect("/frmPresentacionesListado.aspx?nropresentacion=" & nId.ToString, True)
        End If
    End Sub

    Protected Sub btnRetorno_Click(sender As Object, e As EventArgs) Handles btnRetorno.Click
        Response.Redirect("/frmPresentacionesRetornos.aspx", True)
    End Sub
End Class