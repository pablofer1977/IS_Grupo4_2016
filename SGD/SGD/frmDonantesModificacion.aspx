<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmDonantesModificacion.aspx.vb" Inherits="SGD.frmDonantesModificacion" MasterPageFile="~/frmMenu.Master" %>

<asp:Content ID="DonantesModificacion" ContentPlaceHolderID="body" runat="server">
    <div class="container"> 
        <div class="panel-group">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Modificación de Donante</h4>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <label class="control-label col-sm-2" for="nrodonante">Fecha de Ingreso:</label>
